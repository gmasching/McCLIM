...
(deftype colour ()
  '(unsigned-byte 32))
;;[MCCLIM]->defconstants changed to defvars
(defvar +colour-alpha-bits+ (byte 8 24))
(defvar +colour-red-bits+   (byte 8 16))
(defvar +colour-green-bits+ (byte 8 8))
(defvar +colour-blue-bits+  (byte 8 0))
